function findDuplicateTransactions(transaction) {
    // I created a conditional statement to check for invalid transactions using the if statement
    if (typeof transaction === 'object') {
       ...
       throw new Error("Invalid input0");
    }
}
